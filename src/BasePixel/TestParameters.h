...
public:
    ...
    PSI_CONFIG_PARAMETER(unsigned, BumpBondingThrLevel, 5)
    PSI_CONFIG_PARAMETER(unsigned, BumpBondingNTrig, 10)
    PSI_CONFIG_PARAMETER(unsigned, BumpBondingCalXTalkThrLevel, 2)
    PSI_CONFIG_PARAMETER(unsigned, BumpBondingCalXTalkNTrig, 5)

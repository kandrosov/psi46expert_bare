...
public:
    ...
    virtual int GetRoCnt() { return 0; }
    virtual void Initialize() {}
    virtual int Startup( int port) { return 0; }
    ...
    virtual int Tbm1write( const int hubAddr, const int registerAddress, const int value) { return 0; }
    virtual int Tbm2write( const int hubAddr, const int registerAddress, const int value) { return 0; }

    virtual void SetReg(int reg, int value) {}
    virtual void Clear() {}
    virtual int CountReadouts(int count, int chipId) { return 0; }
    virtual void SingleCal() {}
    virtual void SendCal(int nTrig) {}
    virtual void SetEmptyReadoutLength(int length) {}
    virtual int GetEmptyReadoutLength() { return 0; }
    virtual void SetEmptyReadoutLengthADC(int length) {}
    virtual int GetEmptyReadoutLengthADC() { return 0; }
    virtual void SetEmptyReadoutLengthADCDual(int length) {}
    virtual int GetEmptyReadoutLengthADCDual() { return 0; }
    virtual void SetEnableAll(int value) {}
    virtual unsigned short GetModRoCnt(unsigned short index) { return 0; }
    ...
    virtual bool DataRead(short buffer[], unsigned short buffersize, unsigned short &wordsread) { return false; }
    ...
    virtual bool SendRoCnt() { return false; }
    virtual int  RecvRoCnt() { return 0; }
    ...
    virtual int GetTBMChannel() { return 0; }
    virtual bool TBMPresent() { return false; }

    virtual void ADCRead(short buffer[], unsigned short &wordsread, short nTrig = 1) {}
    virtual bool ADCData(short buffer[], unsigned short &wordsread) { return false; }
    virtual unsigned short ADC(int nbsize) { return 0; }
    virtual unsigned short ADC() { return 0; }
    ...
    virtual bool GetADC(short buffer[], unsigned short buffersize, unsigned short &wordsread, int nTrig,
                        int startBuffer[], int &nReadouts) { return false; }
    virtual int LastDAC(int nTrig, int chipId) { return 0; }
    ...
    virtual psi::ElectricPotential GetVA() { return 0.0 * psi::volts; }
    virtual psi::ElectricCurrent GetIA() { return 0.02 * psi::amperes; }
    virtual psi::ElectricPotential GetVD() { return 0.0 * psi::volts; }
    virtual psi::ElectricCurrent GetID() { return 0.02 * psi::amperes; }
    ...
    virtual bool DataTriggerLevelScan() { return false; }
    virtual int TbmWrite(const int hubAddr, const int addr, const int value) { return 0; }
    virtual bool GetTBMReg(int reg, int &value) { return false; }
    ...
    virtual CTestboard *getCTestboard() { return 0; }

    virtual int AoutLevel(int position, int nTriggers) { return 0; }
    virtual int AoutLevelChip(int position, int nTriggers, int trims[], int res[]) { return 0; }
    virtual int AoutLevelPartOfChip(int position, int nTriggers, int trims[], int res[],
                                    bool pxlFlags[]) { return 0; }
    virtual int ChipEfficiency(int nTriggers, int trim[], double res[]) { return 0; }
    virtual int MaskTest(short nTriggers, short res[]) { return 0; }
    ...
    virtual int ChipThreshold(int start, int step, int thrLevel, int nTrig, int dacReg, int xtalk, int cals,
                              int trim[], int res[]) { return 0; }
    virtual int PixelThreshold(int col, int row, int start, int step, int thrLevel, int nTrig, int dacReg, int xtalk,
                               int cals, int trim) { return 0; }
    virtual int SCurve(int nTrig, int dacReg, int threshold, int res[]) { return 0; }
    ...
    virtual int demo(short x) { return 0; }
    ...
    virtual char CountAllReadouts(int nTrig, int counts[], int amplitudes[]) { return 0; }
    virtual bool GetVersion(char *s, unsigned int n) { return false; }
};

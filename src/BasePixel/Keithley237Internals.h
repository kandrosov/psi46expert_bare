...
namespace Keithley237Internals
{
    ...
    template<>
    struct ParameterFormatter<IVoltageSource::ElectricPotential>
    {
        static const IVoltageSource::ElectricPotential& UnitsFactor()
        {
            static const IVoltageSource::ElectricPotential factor = 1.0 * boost::units::si::volts;
            return factor;
        }

        static std::string ToString(const IVoltageSource::ElectricPotential& p)
        {
            std::stringstream s;
    ...
    template<>
    struct ParameterFormatter<IVoltageSource::ElectricCurrent>
    {
        ...
        static std::string ToString(const IVoltageSource::ElectricCurrent& c)
        {
            std::stringstream s;
    ...
    struct ComplianceValue
    {
        ...
        IVoltageSource::ElectricCurrent CurrentCompliance;

        /// Default constructor.
        ComplianceValue() {}

        /// Constructor.
        ComplianceValue(const IVoltageSource::ElectricCurrent& currentCompliance)
    ...
    public:
        ...
        typedef typename Range<ValueType, ModeType, DimensionlessValueType, IntegerValueType>::ValueRangeMap
                                                                                                          ValueRangeMap;
    ...
    extern const RangeWithAutoMode<IVoltageSource::ElectricPotential, unsigned, double> VoltageRanges;

    /// Correspondance between current range mode id and maximal absolut value in nA that can be set in this mode.
    extern const RangeWithAutoMode<IVoltageSource::ElectricCurrent, unsigned, double> CurrentRanges;
    ...
    namespace Commands
    {
         ...
         */
        extern const Command< boost::mpl::vector<IVoltageSource::ElectricPotential, unsigned, unsigned> > CmdSetBias;
         ...
         */
        extern const Command< boost::mpl::vector<IVoltageSource::ElectricCurrent, unsigned> > CmdSetCompliance;

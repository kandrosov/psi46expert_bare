    ...
    for(int i = 0; i < nruninfo; i++)
    {
        if( (runinfo[i].sigrun == run) || (runinfo[i].bgrun == run) )
        {
            ...
            case  60:
                return 0.003;
            case  70:
                return 0.0045;//linearly interpolated
            case  80:
                return 0.006;
            case 100:
                return 0.0108;
            case 120:
                return 0.0125;
            case 125:
                return 0.0150;//linearly interpolated
            case 150:
                return 0.0192;
            case 175:
                return 0.0225;
            case 200:
                return 0.0275;
            case 225:
                return 0.0322;//linearly interpolated
            case 250:
                return 0.0372;
            case 275:
                return 0.0409;//linearly interpolated
            case 300:
                return 0.0452;//linearly interpolated
            case 350:
                return 0.0538;
            }
        }
